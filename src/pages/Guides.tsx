...
import bggGuide from './path/to/BGG 2025_merged.pdf';
 ...
 */
 const GuidesHeading = ({ mobile }: GuidesHeadingProps) => (
  <Container text>
    ...
    />
    <br />
    <Button as="a" primary size="huge" href="/BGG 2025_merged.pdf" target="_blank" download>
          ...
          <Segment inverted textAlign="center" style={{ minHeight: 700, padding: '1em 0em' }} vertical>
            ...
            >
              <Container>
                ...
                <Menu.Item as="a" href="/guides" active>Delegate Handbook</Menu.Item>
              </Container>
            </Menu>
